...
static void usage(void) {
   printf("usage: dot1dStaticTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("dot1dStaticTable");        /* register our .conf handlers */
      init_dot1dStaticTable();  
      init_snmp("dot1dStaticTable");
  ...
  init_agent("dot1dStaticTable");

  /* init dot1dStaticTable mib code */
  init_dot1dStaticTable();  

  /* read dot1dStaticTable.conf files. */
  init_snmp("dot1dStaticTable");
  ...
  /* at shutdown time */
  snmp_shutdown("dot1dStaticTable");
  SOCK_CLEANUP;
  exit(0);
}
