...
static void usage(void) {
   printf("usage: dot1dTpFdbTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("dot1dTpFdbTable");        /* register our .conf handlers */
      init_dot1dTpFdbTable();  
      init_snmp("dot1dTpFdbTable");
  ...
  init_agent("dot1dTpFdbTable");

  /* init dot1dTpFdbTable mib code */
  init_dot1dTpFdbTable();  

  /* read dot1dTpFdbTable.conf files. */
  init_snmp("dot1dTpFdbTable");
