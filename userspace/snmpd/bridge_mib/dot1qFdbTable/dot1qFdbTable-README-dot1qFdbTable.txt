...
------------------------------------------------------------------------
  ...
  the dot1qFdbTable table.  The agent will start by looking for the right
  ...
  file defaults/table-dot1qFdbTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      dot1qFdbTable_allocate_data
      dot1qFdbTable_release_data
 ...
 Index(es) for the dot1qFdbTable table
  ------------------------------------------------------------
  The index(es) for the dot1qFdbTable table are:
...
************************************************************************
dot1qFdbTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the dot1qFdbTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: dot1qFdbTable_data_access.[c|h]
------------------------------------------------------------------------
  The dot1qFdbTable_data_access file contains the interface to your data in
  ...
  FUNC : dot1qFdbTable_indexes_set
  WHERE: dot1qFdbTable_data_access.c
...
File: dot1qFdbTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qFdbDynamicCount_get



File: dot1qFdbTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the dot1qFdbTable table.

To watch the flow of the dot1qFdbTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        dot1qFdbTable
        verbose:dot1qFdbTable
        internal:dot1qFdbTable

e.g.
        snmpd -f -Le -Ddot1qFdbTable,verbose:dot1qFdbTable,internal:dot1qFdbTable
...
/*---------------------------------------------------------------------
 * Q-BRIDGE-MIB::dot1qFdbEntry.dot1qFdbId
 * dot1qFdbId is subid 1 of dot1qFdbEntry.
 ...
 *
 *
 * NOTE: NODE dot1qFdbId IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
