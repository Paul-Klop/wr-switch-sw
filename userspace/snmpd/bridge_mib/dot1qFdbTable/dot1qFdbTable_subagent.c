...
static void usage(void) {
   printf("usage: dot1qFdbTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("dot1qFdbTable");        /* register our .conf handlers */
      init_dot1qFdbTable();  
      init_snmp("dot1qFdbTable");
  ...
  init_agent("dot1qFdbTable");

  /* init dot1qFdbTable mib code */
  init_dot1qFdbTable();  

  /* read dot1qFdbTable.conf files. */
  init_snmp("dot1qFdbTable");
