...
static void usage(void) {
   printf("usage: dot1qPortVlanTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("dot1qPortVlanTable");        /* register our .conf handlers */
      init_dot1qPortVlanTable();  
      init_snmp("dot1qPortVlanTable");
  ...
  init_agent("dot1qPortVlanTable");

  /* init dot1qPortVlanTable mib code */
  init_dot1qPortVlanTable();  

  /* read dot1qPortVlanTable.conf files. */
  init_snmp("dot1qPortVlanTable");
  ...
  /* at shutdown time */
  snmp_shutdown("dot1qPortVlanTable");
  SOCK_CLEANUP;
  exit(0);
}
