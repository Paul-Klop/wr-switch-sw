...
------------------------------------------------------------------------
  ...
  the dot1qTpFdbTable table.  The agent will start by looking for the right
  ...
  file defaults/table-dot1qTpFdbTable.m2d, and then re-running mib2c.
    ...
    in the dot1qTpFdbTable.h header.
    ...
    will be generated:
      ...
      dot1qTpFdbTable_allocate_data
      dot1qTpFdbTable_release_data
 ...
 Index(es) for the dot1qTpFdbTable table
  ------------------------------------------------------------
  The index(es) for the dot1qTpFdbTable table are:
...
************************************************************************
dot1qTpFdbTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the dot1qTpFdbTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: dot1qTpFdbTable_data_access.[c|h]
------------------------------------------------------------------------
  The dot1qTpFdbTable_data_access file contains the interface to your data in
  ...
  FUNC : dot1qTpFdbTable_indexes_set
  WHERE: dot1qTpFdbTable_data_access.c
...
File: dot1qTpFdbTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qTpFdbPort_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qTpFdbStatus_get



File: dot1qTpFdbTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      dot1qTpFdbTable table.

      Conversely, the examples below may not include some functions that
      were generated for the dot1qTpFdbTable table.

To watch the flow of the dot1qTpFdbTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        dot1qTpFdbTable
        verbose:dot1qTpFdbTable
        internal:dot1qTpFdbTable

e.g.
        snmpd -f -Le -Ddot1qTpFdbTable,verbose:dot1qTpFdbTable,internal:dot1qTpFdbTable
...
/*---------------------------------------------------------------------
 * Q-BRIDGE-MIB::dot1qTpFdbEntry.dot1qTpFdbAddress
 * dot1qTpFdbAddress is subid 1 of dot1qTpFdbEntry.
 ...
 *
 *
 * NOTE: NODE dot1qTpFdbAddress IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
