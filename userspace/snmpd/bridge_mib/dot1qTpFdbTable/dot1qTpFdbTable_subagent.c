...
static void usage(void) {
   printf("usage: dot1qTpFdbTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("dot1qTpFdbTable");        /* register our .conf handlers */
      init_dot1qTpFdbTable();  
      init_snmp("dot1qTpFdbTable");
  ...
  init_agent("dot1qTpFdbTable");

  /* init dot1qTpFdbTable mib code */
  init_dot1qTpFdbTable();  

  /* read dot1qTpFdbTable.conf files. */
  init_snmp("dot1qTpFdbTable");
