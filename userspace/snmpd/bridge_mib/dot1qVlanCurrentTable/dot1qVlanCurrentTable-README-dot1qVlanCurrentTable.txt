...
------------------------------------------------------------------------
  ...
  the dot1qVlanCurrentTable table.  The agent will start by looking for the right
  ...
  file defaults/table-dot1qVlanCurrentTable.m2d, and then re-running mib2c.
    ...
    in the dot1qVlanCurrentTable.h header.
    ...
    will be generated:
      ...
      dot1qVlanCurrentTable_allocate_data
      dot1qVlanCurrentTable_release_data
 ...
 Index(es) for the dot1qVlanCurrentTable table
  ------------------------------------------------------------
  The index(es) for the dot1qVlanCurrentTable table are:

     dot1qVlanTimeMark:
        Syntax:      TimeFilter
        DataType:    TICKS
        ASN type:    ASN_TIMETICKS
        C-code type: u_long
     dot1qVlanIndex:
        Syntax:      VlanIndex
        DataType:    UNSIGNED32
...
************************************************************************
dot1qVlanCurrentTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the dot1qVlanCurrentTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: dot1qVlanCurrentTable_data_access.[c|h]
------------------------------------------------------------------------
  The dot1qVlanCurrentTable_data_access file contains the interface to your data in
  ...
  FUNC : dot1qVlanCurrentTable_indexes_set
  WHERE: dot1qVlanCurrentTable_data_access.c
...
File: dot1qVlanCurrentTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanFdbId_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanCurrentEgressPorts_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanCurrentUntaggedPorts_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanCreationTime_get



File: dot1qVlanCurrentTable_data_set.c
------------------------------------------------------------------------
...
************************************************************************
dot1qVlanCurrentTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      dot1qVlanCurrentTable table.

      Conversely, the examples below may not include some functions that
      were generated for the dot1qVlanCurrentTable table.

To watch the flow of the dot1qVlanCurrentTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        dot1qVlanCurrentTable
        verbose:dot1qVlanCurrentTable
        internal:dot1qVlanCurrentTable

e.g.
        snmpd -f -Le -Ddot1qVlanCurrentTable,verbose:dot1qVlanCurrentTable,internal:dot1qVlanCurrentTable
...
/*---------------------------------------------------------------------
 * Q-BRIDGE-MIB::dot1qVlanCurrentEntry.dot1qVlanTimeMark
 * dot1qVlanTimeMark is subid 1 of dot1qVlanCurrentEntry.
 ...
 *
 *
 * Its syntax is TimeFilter (based on perltype TICKS)
 * The net-snmp type is ASN_TIMETICKS. The C type decl is u_long (u_long)
 *
 *
 *
 * NOTE: NODE dot1qVlanTimeMark IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
 * Q-BRIDGE-MIB::dot1qVlanCurrentEntry.dot1qVlanIndex
 * dot1qVlanIndex is subid 2 of dot1qVlanCurrentEntry.
 * Its status is Current, and its access level is NoAccess.
 ...
 * Attributes:
 *   accessible 0     isscalar 0     enums  0      hasdefval 0
 *   readable   0     iscolumn 1     ranges 0      hashint   1
 *   settable   0
 *   hint: d
 *
 *
 ...
 *
 *
 * NOTE: NODE dot1qVlanIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
