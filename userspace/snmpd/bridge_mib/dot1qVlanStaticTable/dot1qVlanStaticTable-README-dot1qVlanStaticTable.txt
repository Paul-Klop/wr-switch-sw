...
------------------------------------------------------------------------
  ...
  the dot1qVlanStaticTable table.  The agent will start by looking for the right
  ...
  file defaults/table-dot1qVlanStaticTable.m2d, and then re-running mib2c.
    ...
    in the dot1qVlanStaticTable.h header.
    ...
    will be generated:
      ...
      dot1qVlanStaticTable_allocate_data
      dot1qVlanStaticTable_release_data
 ...
 Index(es) for the dot1qVlanStaticTable table
  ------------------------------------------------------------
  The index(es) for the dot1qVlanStaticTable table are:
...
************************************************************************
dot1qVlanStaticTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the dot1qVlanStaticTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: dot1qVlanStaticTable_data_access.[c|h]
------------------------------------------------------------------------
  The dot1qVlanStaticTable_data_access file contains the interface to your data in
  ...
  FUNC : dot1qVlanStaticTable_indexes_set
  WHERE: dot1qVlanStaticTable_data_access.c
...
File: dot1qVlanStaticTable_enums.h
------------------------------------------------------------------------
...
File: dot1qVlanStaticTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanStaticName_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanStaticEgressPorts_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanForbiddenEgressPorts_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanStaticUntaggedPorts_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1qVlanStaticRowStatus_get



File: dot1qVlanStaticTable_data_set.c
------------------------------------------------------------------------
...
************************************************************************
dot1qVlanStaticTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      dot1qVlanStaticTable table.

      Conversely, the examples below may not include some functions that
      were generated for the dot1qVlanStaticTable table.

To watch the flow of the dot1qVlanStaticTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        dot1qVlanStaticTable
        verbose:dot1qVlanStaticTable
        internal:dot1qVlanStaticTable

e.g.
        snmpd -f -Le -Ddot1qVlanStaticTable,verbose:dot1qVlanStaticTable,internal:dot1qVlanStaticTable
