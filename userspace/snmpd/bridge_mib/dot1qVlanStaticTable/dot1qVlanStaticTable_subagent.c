...
static void usage(void) {
   printf("usage: dot1qVlanStaticTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("dot1qVlanStaticTable");        /* register our .conf handlers */
      init_dot1qVlanStaticTable();  
      init_snmp("dot1qVlanStaticTable");
  ...
  init_agent("dot1qVlanStaticTable");

  /* init dot1qVlanStaticTable mib code */
  init_dot1qVlanStaticTable();  

  /* read dot1qVlanStaticTable.conf files. */
  init_snmp("dot1qVlanStaticTable");
  ...
  /* at shutdown time */
  snmp_shutdown("dot1qVlanStaticTable");
  SOCK_CLEANUP;
  exit(0);
}
